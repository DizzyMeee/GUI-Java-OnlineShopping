...
public class Olshop extends JFrame implements ActionListener{
	...
	this.setTitle("Online Shop");
        ...
        txt_quantity.setDocument(new OnlyDigit().getOnlyDigit());
        ...
        cb_filter.setModel(new DefaultComboBoxModel<>(new String[] {"Baju", "Gelas", "Piring", "Celana", "Lampu Belajar", "Hiasan Dinding", "Rak", "Alat Kebersihan", "Peralatan Dapur" }));
    ...
    private void setIconImage(){
        ...
        List data = new Product().show_dataAvailable();
        String[] str = (String[])data.toArray(new String[0]);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource().equals(btn_buy)) {
            ...
            if(cek.equals("Valid.")) {
                set_data();
                if(prodQuantity < quantityNeeded){
        	...
        	txt_quantity.setText("");
                ...
                Interface_Login ilc = new Interface_Login();
            ...
            if(inside.length() > 0){
                ...
                JOptionPane.showMessageDialog(null, "You didn't buy anything");
            }
	}	
    }
}