...
public class ManageProduct extends JFrame implements ActionListener{
    ...
    public ManageProduct(){
        ...
        cb_category.setModel(new DefaultComboBoxModel<>(new String[] {"Baju", "Gelas", "Piring", "Celana", "Lampu Belajar", "Hiasan Dinding", "Rak", "Alat Kebersihan", "Peralatan Dapur" }));
 	...
 	this.getContentPane().add(cb_category);
        ...
        txt_stock.setDocument(new OnlyDigit().getOnlyDigit());
        ...
        txt_price.setDocument(new OnlyDigit().getOnlyDigit());
		  ...
		  if(e.getSource().equals(btn_add)) {
	            ...
	            if(cek.equals("Valid.")) {
                   ...
                   if(!txt_search.getText().equals("")){
                    ...
                    if(cek.equals("Valid.")){
                        set_data();
                        String save = new Product().delete_data(name, category, stock, price);
                        JOptionPane.showMessageDialog(null, save);
                        refresh();
                        reset();
                    }else{
